...
export default function Footer() {
  return (
    <footer className='flex flex-col justify-center items-center gap-5 bg-dark-300 text-pink px-4 pt-5 pb-4 text-center'>
      ...
      <h2 className='text-pink text-md font-bold'>Socials</h2>
